...
1. open 2 terminal and cd into /frontend and /backend
2. use "npm i" command in both of them
3. in backend use "node server" command
4. on fronted use "npm start" command 
